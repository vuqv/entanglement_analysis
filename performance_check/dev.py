"""
the open terminal is alway maximize length
"""
import sys, time
        ...
        if dis_i1i2 < d:
            ...
            for i in range(i1, i2):
                ...
                for j in range(j1, j2):
                    temp = np.dot((ave_positions[i, :] - ave_positions[j, :]) / (
                            np.linalg.norm(ave_positions[i, :] - ave_positions[j, :]) ** 3),
            ...
            if final_G < np.abs(Gc_ij):
                ...
                IDX_i1 = i1
                IDX_i2 = i2
                print(f'C-term: {final_G : .2f} {IDX_i1} {IDX_i2} {j1} {j2}')
            ...
            if final_G < np.abs(Gn_ij):
                ...
                IDX_i1 = i1
                IDX_i2 = i2
                print(f'N-term: {final_G : .2f} {IDX_i1} {IDX_i2} {j1} {j2}')
