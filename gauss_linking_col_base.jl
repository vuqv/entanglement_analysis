"""
The code base here is just used as a reference of how col-base work in julia.
It is slower than gauss_linking.jl by 3% and memory usage is similar.
use default version-which is row-based for readability.
"""
